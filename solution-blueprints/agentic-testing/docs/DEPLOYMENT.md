...
# Agentic Testing Deployment Guide
...
> **Helm note**: Built and tested on Helm 3.17 or higher. On Helm v4, if the piped `kubectl apply` is rejected, run `helm pull oci://registry-1.docker.io/amdenterpriseai/aimsb-agentic-testing --untar` first and template the local `./aimsb-agentic-testing` directory instead.
...
By default, the chart deploys GPT-OSS 120B with this AIM: `amdenterpriseai/aim-openai-gpt-oss-120b:0.11.1`
